...
cwd = os.getcwd()
prefix = cwd+"/paper_data/generated_data/sl5modp_lb221/"
...
print("------------------- (SL(5,CC),L([2,2,1])) data generation started ------------------")
...
Sl5ModP_LB221 = FlagVariety._get_flag_variety([2,2,1],n=5)

#===============================================================================================================
#===============================================================================================================

print("saving bruhat poset image")
p = Sl5ModP_LB221.print_poset(size=15)
...
save_coordinates(Sl5ModP_LB221,fname=prefix+"plucker_coordinates")
...
Sl5ModP_LB221_HB = FlagVarietyWithHBOfTInvariants(variety=Sl5ModP_LB221)

print("2. calculating hb")
#G37HB.hb = load(hb_data+"gr37hb.hb_vecs_list")
HBSl5ModP_LB221 = TInvariantSemistandardMonomials(variety=Sl5ModP_LB221,monomials=Sl5ModP_LB221_HB.hb_monomials(verbose = False,save_data=SAVE,fname_prefix=chains_data)) 
print("3. separating hb elements degree wise")
print("3.1. collecting degree 1 elements in hb")
HBSl5ModP_LB221_1 = TInvariantSemistandardMonomials(variety=Sl5ModP_LB221,monomials=Sl5ModP_LB221_HB.hb_monomials(deg = 1,verbose=False,save_data=SAVE,fname_prefix=hb_data)) 
print("3.2. collecting degree 2 elements in hb")
HBSl5ModP_LB221_2 = TInvariantSemistandardMonomials(variety=Sl5ModP_LB221,monomials=Sl5ModP_LB221_HB.hb_monomials(deg = 2,verbose=False,save_data=SAVE,fname_prefix=hb_data)) 


print("------------------- (SL(5,CC),L([2,2,1])) data generation finished ------------------")
#===============================================================================================================
#===============================================================================================================
